...
import ErrorPage from './ErrorPage';  // << Import your 404 component here
    ...
    <>
      {noNavBar ? (
        <Routes>
          ...
          <Route path="/employee_register" element={<MaterialEmployeeRegister />} />
          ...
          content={
            <Routes>
              <Route element={<ProtectedRoutes />}>
                ...
                <Route path="/create/fingerprint" element={<RegisterFingerprint />} />
